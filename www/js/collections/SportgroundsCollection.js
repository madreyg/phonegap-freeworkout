    ...
    return LayoutCollection.extend({
        ...
        url: function () {
            ...
            return ["http://free-workout.ru/workout/api/sportgrounds/?page=" + this.fltr.page,
                'district=' + ((flagFilter && localStorage.getItem('district') !== 0 && localStorage.getItem('district') !== '0') ? localStorage.getItem('district') : ''),
                'query=' + (localStorage.getItem('sportgroundsQuery') || ''),
                'subway_station=' + ((flagFilter && localStorage.getItem('station') !== 0 && localStorage.getItem('station') !== '0') ? localStorage.getItem('station') : ''),
